...
export async function POST(request: NextRequest) {
  try {
    ...
    // Only superadmin can upload testimonial images
    ...
    // Upload to Cloudinary using the File object directly
    try {
    ...
    console.error('Upload testimonial image API error:', error);
    return NextResponse.json(
      { 
        success: false, 
