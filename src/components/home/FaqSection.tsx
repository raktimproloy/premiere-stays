        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-12">
            <div className="inline-flex gap-2">
              <button
                className={`px-6 py-3 text-lg font-medium transition-colors duration-300 rounded-full cursor-pointer ${
                  activeTab === 'property' 
              ...
              >
                Property MGMT with Premiere Stays
              </button>
              <button
                className={`px-6 py-3 text-lg font-medium transition-colors duration-300 rounded-full cursor-pointer ${
                  activeTab === 'booking' 
        ...
        <div className="">
          <div className="flex flex-col gap-2">
            {currentFAQs.map((faq) => (
              ...
              >
                <button
                  className={`w-full flex justify-between rounded-lg cursor-pointer items-center p-6 text-left transition-colors duration-300 text-black ${
                ...
                <div 
                  className={`overflow-hidden transition-all rounded-b-lg duration-300 bg-white ease-in-out ${
                    activeQuestion === faq.id ? 'max-h-96 opacity-100 pt-6' : 'max-h-0 opacity-0'
                  }`}
                >
