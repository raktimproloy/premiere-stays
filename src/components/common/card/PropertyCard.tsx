    ...
    >
      ...
      <div className="relative h-48 sm:h-56 md:h-64">
        <div className="absolute inset-0">
            <Image src={property.image} alt={property.title} width={1000} height={1000} className="w-full h-full object-cover rounded-t-xl" />
        </div>
      ...
      <div className="p-4 sm:p-5 md:p-6">
        ...
        <div className="flex justify-between items-center">
          <div className='flex items-center'>
            <div className="text-lg sm:text-xl font-bold text-gray-900">${property.price.toFixed(2)}</div>
