            ...
            <div className="sm:col-span-2 lg:col-span-2 border-l-0 sm:border-l lg:border-l border-gray-600 pl-0 sm:pl-4 lg:pl-8">
              ...
              <ul className="space-y-2 sm:space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base text-gray-400">#1 Dealing Street, St. Thomas Village, Chagastons, Trinidad & Tobago</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8">
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0'>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors">
              ...
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors">
